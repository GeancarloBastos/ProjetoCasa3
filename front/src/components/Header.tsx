        ...
        <div className="flex items-center justify-between h-24">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              <Link
                href="/"
                className="text-colorc3offbranco hover:text-colorc3verde px-3 py-2 rounded-md text-md font-medium"
              >
                Início
              </Link>
              <Link
          ...
          <div className="-mr-2 flex md:hidden">
            <button
              onClick={() => setIsMenuOpen(!isMenuOpen)}
              className="inline-flex items-center justify-center p-2 rounded-md text-colorc3offbranco hover:text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-800 focus:ring-white"
            >
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link
              href="/"
              className="text-colorc3offbranco hover:text-colorc3verde block px-3 py-2 rounded-md text-base font-medium"
            >
              Início
            </Link>
            <Link
